  ...
  try {
    ...
    if (!hasSupabase || forceDevMode) {
      ...
      const formData = {
        ...
        skillsPriority: data.skillsPriority,
        otherSkill: data.otherSkill,
        currentBests: data.currentBests,
        conditioningPreferences: data.conditioningPreferences,
        otherConditioning: data.otherConditioning,
        sorenessPreference: data.sorenessPreference,
