...
export default function Header({ onToggleSidebar, onContactSales, onLoginClick }: HeaderProps) {
  ...
  // Landing page, Research page, Safety page, Business page, Developers page, Pricing page, Contact page, Solutions page, Company page, and Legal page header - using CSS modules styling
