      ...
      <div className={`welcome-screen ${currentScreen === 'welcome' ? 'active' : 'hidden'}`}>
        <div className="welcome-content">
          ...
          <p className="welcome-subtitle">
            ...
            forge builds nutrition intelligence from your unique biology.
          </p>
          ...
          {slackConnected ? (
            ...
            <div style={{marginBottom: '40px'}}>
              <div style={{
                ...
                <svg width="48" height="48" viewBox="0 0 127 127" fill="none" xmlns="http://www.w3.org/2000/svg">
