      ...
      <section className="content-section">
        ...
        <div className="content-container">
          ...
          <div className="content-block">
            ...
            <p className="section-text"><strong>sage</strong> is free for the first users. If you find it useful, feel free to share with your friends. Visit <a href="https://moccet.ai" target="_blank" rel="noopener noreferrer">moccet.ai</a> for the full platform that delivers daily insights across all aspects of health, not just nutrition.</p>
          </div>
