...
export default function SageClient() {
    ...
    <main className="sage-page-moccet">
      <section className="first-page">
        ...
        <div className="background-image-container">
          <Image
            src="/images/sage-hero-optimized.jpg"
            alt="Sage background"
            fill
            priority
            quality={90}
      ...
      <section className="content-section">
        ...
        <div className="content-container">
          ...
          <div className="content-block">
            ...
            <p className="section-text"><strong>sage</strong> is free for the first users. If you find it useful, feel free to share with your friends. Visit <a href="https://www.moccet.ai" target="_blank" rel="noopener noreferrer">moccet.ai</a> for the full platform that delivers daily insights across all aspects of health, not just nutrition.</p>
          </div>
