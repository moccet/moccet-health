...
export const organizationSchema = {
  ...
  "contactPoint": {
    ...
    "url": "https://www.moccet.ai/contact"
  }
};
...
export const sageProductSchema = {
  ...
  "@graph": [
    {
      "@type": "MedicalWebPage",
      "@id": "https://www.moccet.ai/sage#webpage",
...
export const forgeProductSchema = {
  ...
  "@graph": [
    {
      "@type": "MedicalWebPage",
      "@id": "https://www.moccet.ai/forge#webpage",
...
export const websiteSchema = {
  ...
  "potentialAction": {
    "@type": "SearchAction",
    "target": "https://www.moccet.ai/search?q={search_term_string}",
