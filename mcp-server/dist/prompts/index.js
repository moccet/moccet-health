...
// PROMPT HANDLERS
// =============================================================================
async function analyzeDeficiency(args, config) {
    const { nutrient } = args;
    return {
        messages: [
            {
...
async function optimizeSleep(args, config) {
...
async function supplementProtocol(args, config) {
...
async function weeklyHealthReview(args, config) {
    return {
        messages: [
            {
                role: 'user',
...
async function glucoseOptimization(args, config) {
...
async function recoveryPlan(args, config) {
    return {
        messages: [
            {
                role: 'user',
